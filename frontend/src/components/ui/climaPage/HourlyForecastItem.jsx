...
/**
 * Muestra el pronóstico para una hora específica.
 * @param {string} time - Hora (ej: "14:00").
 * @param {string} iconName - Nombre del icono de Material Symbols (ej: "sunny").
 * @param {string} temperature - Temperatura (ej: "23°C").
 * @param {boolean} isSelected - Indica si es la hora actualmente seleccionada.
 */
